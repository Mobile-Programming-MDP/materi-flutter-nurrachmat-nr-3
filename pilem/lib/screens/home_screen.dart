...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadMovies() async {
    final List<Map<String, dynamic>> allMoviesData = await _apiService
        .getAllMovies();
    final List<Map<String, dynamic>> trendingMovieData = await _apiService
        .getTrendingMovies();
    ...
    setState(() {
      ...
      _trendingMovies = trendingMovieData
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            _buildMovieList("All Movies", _allMovies), //list all movie
            _buildMovieList("Popular Movies", _popularMovies), //list popular
            _buildMovieList("Trending Movies", _trendingMovies), //list trending
          ],
        ),
      ),
    );
